...
class EmailMessage(object):
    ...
    def get_connection(self, fail_silently=False):
        from tornadoapi.core.mail import get_connection
    ...
    def message(self):
        ...
        msg['To'] = self.extra_headers.get('To', ', '.join(map(to_text, self.to)))
        if self.cc:
            msg['Cc'] = ', '.join(map(to_text, self.cc))
        if self.reply_to:
            msg['Reply-To'] = self.extra_headers.get('Reply-To', ', '.join(map(to_text, self.reply_to)))
